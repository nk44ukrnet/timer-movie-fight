...
function calculator() {
  ...
  var sx, height, weight, age, ratio;
  sx = localStorage.getItem('sx') || 'female';
  ...
  function initLocalSettings(selector, activeClass) {
    ...
    elements.forEach(function (element) {
      ...
      if (element.getAttribute('id') === localStorage.getItem('sx')) {
    ...
    elements.forEach(function (elem) {
      elem.addEventListener('click', function (e) {
        if (e.target.getAttribute('data-ratio')) {
          ...
          sx = e.target.getAttribute('id');
          localStorage.setItem('sx', e.target.getAttribute('id'));
        }
...
function cards() {
  var menuField = document.querySelector('.menu__field .container');

  var MenuesClass = /*#__PURE__*/function () {
    function MenuesClass(img, title, desc, price, append) {
      var transfer = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 1;

      _classCallCheck(this, MenuesClass);
    ...
    _createClass(MenuesClass, [{
      ...
      key: "insertToThePage",
      value: function insertToThePage() {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      form.append(statusMessage); // const request = new XMLHttpRequest();
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_6__.postData)('http://localhost:3000/requests', object).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_5__.openModal)('.modal', modalTimerId);
...
function openModal(triggerSelector, modelTimerId) {
  var modal = document.querySelector(triggerSelector);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  function hideTabContent() {
    ...
    tabs.forEach(function (item) {
      item.classList.remove(tabsSelector);
    });
  }
  ...
  function showTabContent() {
    ...
    tabs[i].classList.add(tabsSelector);
  }
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemeaning(endtime);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__.default)('.timer', '2020-11-15');
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)(modalTimerId, 'form');
});
